...
export async function setupVite(app: Express, server: Server) {
  ...
  app.use("*", async (req, res, next) => {
    ...
    // Pass API requests through — they are handled by dedicated Express routes
  ...
  "@graph": [
    {
      ...
      "potentialAction": {
        "@type": "SearchAction",
        "target": "https://truthdesk.claims/registry?q={search_term_string}",
...
<noscript>
  ...
  const jsonLd = JSON.stringify({
    ...
    "@graph": [
      {
        "@type": "WebSite",
        "@id": "https://truthdesk.claims/#website",
        "url": "https://truthdesk.claims/",
        "name": "Truth Desk",
        ...
        "publisher": { "@type": "Organization", "name": "Arctic Media LLC", "url": "https://truthdesk.claims/" }
      },
      {
        "@type": "SoftwareApplication",
        "@id": "https://truthdesk.claims/#app",
        "name": "Truth Desk",
