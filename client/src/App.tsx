...
const PredictionCalibration = lazy(
  () => import("@/pages/PredictionCalibration")
);
...
const AutonomousLoopDashboard = lazy(
  () => import("@/pages/AutonomousLoopDashboard")
);
...
const VerticalManagement = lazy(
  () => import("@/pages/admin/VerticalManagement")
);
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Switch>
        ...
        <Route path="/countrydesk/iceland" component={CountryDeskIceland} />
        ...
        <Route
          path="/contradictions/:relationId"
          component={ContradictionViewer}
        />
        ...
        <Route
          ...
          component={InversePromptDashboard}
        />
        ...
        <Route path="/admin/harness" component={AdminHarness} />
